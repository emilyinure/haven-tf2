...
void c_groupbox::paint( ) {
	...
	// title background.
	g_ui.m_draw.filled_rect( { this->m_area.m_x, this->m_area.m_y, this->m_area.m_w, 15 }, color( 35, 35, 35, 40 * g_ui.m_fade )  );
	...
	// title text.
	g_render.text( g_render.m_fonts.menu.main, { this->m_area.m_x + ( this->m_area.m_w * 0.5f ), this->m_area.m_y }, this->m_name, color( 255, 255, 255, 100 * g_ui.m_fade ) , e_text_alignment::text_align_center );
