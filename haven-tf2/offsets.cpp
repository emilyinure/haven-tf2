...
void c_offsets::init()
{
    const auto vgui_mat_surface = g_modules.get("vguimatsurface.dll");
    {
        ...
        this->m_sigs.start_drawing =
            vgui_mat_surface
                .get_sig("40 53 56 57 48 83 EC 50").m_ptr;
        

        // x-ref "Too many popups! Rendering will be bad!".
        this->m_sigs.finish_drawing =
            vgui_mat_surface.get_sig("40 53 48 83 EC 20 33 C9").m_ptr;
    }
    ...
    const auto client = g_modules.get("client.dll");
    {
        ...
        this->m_sigs.compute_hitbox_surrounding_box =
            client
                .get_sig("48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 56 48 81 EC 50 04")
                .m_ptr;

        // x-ref "Usage: \"load_itempreset <preset index>\"
        this->m_sigs.in_cond = client.get_sig("48 89 5C 24 08 57 48 83 EC 20 8B DA 48 8B F9 83 FA 20").m_ptr;
