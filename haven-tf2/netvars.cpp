...
void c_netvars::iterate_props(const unsigned int name, recv_table* table, int offset) {
  ...
  for (int i = 0; i < table->m_num_of_props; i++) {
    ...
    this->m_netvars.emplace_back(name, g_utils.fnv_hash(prop.m_var_name),
...
void c_netvars::init() {
  ...
  while (cc) {
    ...
    for (int i = 0; i < table->m_num_of_props; i++) {
      ...
      this->m_netvars.emplace_back(g_utils.fnv_hash(table->m_net_table_name),
                                   g_utils.fnv_hash(prop.m_var_name), prop.m_offset);
    }
...
void c_netvars::get_offsets() {
  this->m_offsets.dt_base_entity.m_vec_origin =
      this->get("DT_BaseEntity", "m_vecOrigin").m_offset;
  this->m_offsets.dt_base_entity.m_vec_view_offset =
      this->get("DT_TFPlayer", "m_vecViewOffset[0]").m_offset;
  this->m_offsets.dt_base_entity.m_max_speed =
      this->get("DT_TFPlayer", "m_flMaxspeed").m_offset;
  this->m_offsets.dt_base_entity.m_i_team_num =
      this->get("DT_BaseEntity", "m_iTeamNum").m_offset;
  this->m_offsets.dt_base_entity.m_owner_handle =
  ...
  this->m_offsets.dt_base_weapon.m_charge_damage =
      this->get("DT_BaseCombatWeapon", "m_flChargedDamage").m_offset;
  this->m_offsets.dt_base_weapon.m_rot_speed =
      this->get("DT_BaseCombatWeapon", "m_flRotationSpeed").m_offset;

  this->m_offsets.dt_base_weapon.m_clip1 =
      this->get("DT_BaseCombatWeapon", "m_iClip1").m_offset;
  this->m_offsets.dt_base_weapon.m_clip2 =
      this->get("DT_BaseCombatWeapon", "m_iClip2").m_offset;

  this->m_offsets.dt_base_animating.m_hitbox_set =
      this->get("DT_BaseAnimating", "m_nHitboxSet").m_offset;
  this->m_offsets.dt_base_animating.m_model_scale =
      this->get("DT_BaseAnimating", "m_flModelScale").m_offset;

  this->m_offsets.dt_player_resource.m_max_health =
      this->get("DT_TFPlayerResource", "m_iMaxBuffedHealth").m_offset;
  this->m_offsets.dt_base_player.m_shared = this->get("DT_TFPlayer", "m_Shared").m_offset;
  this->m_offsets.dt_base_player.m_active_weapon =
      this->get("DT_BaseCombatCharacter", "m_hActiveWeapon").m_offset;
  this->m_offsets.dt_base_player.m_eye_angles =
      this->get("DT_TFPlayer", "m_angEyeAngles[0]").m_offset;
  this->m_offsets.dt_base_player.m_class = this->get("DT_TFPlayer", "m_iClass").m_offset;
  this->m_offsets.dt_base_player.m_taunt =
      this->get("DT_TFPlayer", "m_nForceTauntCam").m_offset;
  this->m_offsets.dt_base_player.m_tick_base =
      this->get("DT_BasePlayer", "m_nTickBase").m_offset;
  this->m_offsets.dt_base_player.m_next_attack =
      this->get("DT_BaseCombatCharacter", "m_flNextAttack").m_offset;
  this->m_offsets.dt_base_player.m_max_speed =
      this->get("DT_BasePlayer", "m_flMaxspeed").m_offset;
  this->m_offsets.dt_base_player.m_velocity =
      this->get("DT_TFPlayer", "m_vecVelocity[0]").m_offset;
  this->m_offsets.dt_base_player.m_i_health = this->get("DT_BasePlayer", "m_iHealth").m_offset;
  this->m_offsets.dt_base_player.m_life_state =
      this->get("DT_BasePlayer", "m_lifeState").m_offset;
  this->m_offsets.dt_base_player.m_ground_handle =
      this->get("DT_TFPlayer", "m_hGroundEntity").m_offset;
  this->m_offsets.dt_base_player.m_flags = this->get("DT_BasePlayer", "m_fFlags").m_offset;
  this->m_offsets.m_fl_conveyor_speed =
      this->get("DT_FuncConveyor", "m_flConveyorSpeed").m_offset;
}
