...
void c_netvars::get_offsets( ) {
	...
	this->m_offsets.dt_base_weapon.m_charge_begin_time = this->get( "DT_WeaponCompoundBow", "m_flChargeBeginTime" ).m_offset;
	this->m_offsets.dt_base_weapon.m_pipe_charge_begin_time = this->get( "DT_WeaponPipebombLauncher", "m_flChargeBeginTime" ).m_offset;
	this->m_offsets.dt_base_weapon.m_next_primary_attack = this->get( "DT_BaseCombatWeapon", "m_flNextPrimaryAttack" ).m_offset;
	this->m_offsets.dt_base_weapon.m_next_secondary_attack = this->get( "DT_BaseCombatWeapon", "m_flNextSecondaryAttack" ).m_offset;
	this->m_offsets.dt_base_weapon.m_item_definition_index = this->get( "DT_EconEntity", "m_iItemDefinitionIndex" ).m_offset;
