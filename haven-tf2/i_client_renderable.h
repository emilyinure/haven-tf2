...
public:
  ...
  virtual bool         setup_bones(matrix_3x4* bone_to_world_out, int max_bones, int bone_mask,
                                   float current_time)                                 = 0;
  virtual void         setup_weights(const matrix_3x4* bone_to_world, int flex_weight_count,
  ...
  virtual void         get_shadow_render_bounds(vector& mins, vector& maxs,
  ...
  virtual bool get_shadow_cast_direction(vector*       direction,
