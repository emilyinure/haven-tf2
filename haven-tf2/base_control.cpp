...
void c_base_control::paint_tooltip( ) {
	if ( !g_input.hovering( this->m_area ) || this->m_tooltip == "" || ( g_ui.m_focused_control && g_ui.m_focused_control != this ) ) {
	...
	// text.
	g_ui.m_draw.text( g_render.m_fonts.menu.tooltip, { tooltip_area.m_x + 2, tooltip_area.m_y }, this->m_tooltip, { 255, 255, 255 }, e_text_alignment::text_align_left );
}