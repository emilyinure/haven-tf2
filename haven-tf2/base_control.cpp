...
void c_base_control::paint_tooltip() {
  ...
  const auto text_size =
      g_ui.m_draw.get_text_size(this->m_tooltip, g_render.m_fonts.menu.tooltip);
  ...
  // text.
  g_ui.m_draw.text(g_render.m_fonts.menu.tooltip, {tooltip_area.m_x + 2, tooltip_area.m_y},
                   this->m_tooltip, {255, 255, 255}, e_text_alignment::text_align_left);
}
