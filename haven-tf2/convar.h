...
public:
    ...
    virtual void create(const char* name, const char* default_value, int flags = 0, const char* help_string = 0,
                        bool min = false, float f_min = 0.0, bool b_max = false, float f_max = false,
