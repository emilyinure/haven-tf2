...
public:
	virtual int command_completion_callback( const char* partial, c_utl_vector< c_utl_string >& commands ) = 0;
};
...
public:
	...
	virtual void create( const char* name, const char* default_value, int flags = 0, const char* help_string = 0, bool min = false, float f_min = 0.0, bool b_max = false, float f_max = false, fn_change_callback_t callback = 0 );
	virtual void init( );
