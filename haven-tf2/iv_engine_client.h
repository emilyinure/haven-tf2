...
public:
  virtual int         get_intersecting_surfaces(const model_t* model, const vector& v_center,
                                                const float radius, const bool only_visible_surfaces,
                                                surf_info* infos, const int max_infos)      = 0;
  virtual vector      get_light_for_point(const vector& pos, bool clamp)                    = 0;
  virtual i_material* trace_line_material_and_lighting(const vector& start, const vector& end,
                                                       vector& diffuse_light_color,
                                                       vector& base_color)                  = 0;
  ...
  virtual void               compute_dynamic_lighting(const vector& pt, const vector* normal,
                                                      vector& color)                        = 0;
  ...
  virtual bool does_box_touch_area_frustum(const vector& mins, const vector& maxs,
                                           int i_area)                                      = 0;
  ...
  virtual void        compute_lighting(const vector& pt, const vector* normal, bool clamp,
                                       vector& color, vector* box_colors = NULL)            = 0;
  ...
  virtual void  debug_draw_phys_collide(const c_phys_collide* collide, i_material* material,
                                        matrix_3x4& transform, const color32& color)        = 0;
