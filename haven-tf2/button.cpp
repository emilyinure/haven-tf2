...
void c_button::paint() {
  // background.
  g_ui.m_draw.filled_rect(this->m_area,
                          this->m_pressed ? g_ui.m_theme : color(35, 35, 35, 40 * g_ui.m_fade));
  g_ui.m_draw.outlined_rect(this->m_area, color(35, 35, 35, 40 * g_ui.m_fade));

  // title.
  g_ui.m_draw.text(
      g_render.m_fonts.menu.main,
      {this->m_area.m_x + 2 + ((this->m_area.m_w - 4) * 0.5f), this->m_area.m_y + 3},
