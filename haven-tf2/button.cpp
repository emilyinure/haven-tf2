...
void c_button::paint( ) {
	...
	// title.
	g_ui.m_draw.text( g_render.m_fonts.menu.main, { this->m_area.m_x + 2 + ( ( this->m_area.m_w - 4 ) * 0.5f ), this->m_area.m_y + 3 }, this->m_name, color( 255, 255, 255, 100 * g_ui.m_fade) , e_text_alignment::text_align_center );
}
