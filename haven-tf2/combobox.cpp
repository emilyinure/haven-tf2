...
void c_combobox::paint() {
  ...
  if (!this->open_)
    g_ui.m_draw.text(
        g_render.m_fonts.menu.main, {this->dropdown_area_.m_x + 2, this->dropdown_area_.m_y},
...
void c_combobox::add_item(const char* item) { this->items_.emplace_back(item); }
