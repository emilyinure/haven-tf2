...
public:
  ...
  virtual int           in_key_event(int event_code, button_code_t key_num,
                                     const char* current_binding)                          = 0;
  ...
  virtual bool write_user_cmd_delta_to_buffer(bf_write* buf, int from, int to,
  ...
  virtual void save_write_fields(c_save_restore_data*, const char*, void*, data_map_t*,
                                 type_description_t*, int)                                 = 0;
  virtual void save_read_fields(c_save_restore_data*, const char*, void*, data_map_t*,
                                type_description_t*, int)                                  = 0;
