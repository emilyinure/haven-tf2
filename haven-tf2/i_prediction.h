...
public:
  ...
  uintptr_t m_nPlayerHandle; // edict index on server, client entity handle on client
...
public:
  ...
  virtual void Update(int startframe, bool validframe, int incoming_acknowledged,
...
public:
  ...
  virtual void SetupMove(c_base_entity* player, usercmd_t* ucmd, CMoveHelper* pHelper,
                         CMoveData* move)                                                  = 0;
  virtual void FinishMove(c_base_entity* player, usercmd_t* ucmd, CMoveData* move)         = 0;
  virtual void SetIdealPitch(c_base_entity* player, const vector& origin, const vector& angles,
                             const vector& viewheight)                                     = 0;
  virtual void _Update(bool received_new_world_update, bool validframe,
                       int incoming_acknowledged, int outgoing_command)                    = 0;
