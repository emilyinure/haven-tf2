...
void c_checkbox::paint() {
  ...
  g_ui.m_draw.filled_rect(this->m_area, this->m_value ? g_ui.m_theme
                                                      : color(100, 100, 100, 40 * g_ui.m_fade));
  g_ui.m_draw.outlined_rect(this->m_area, color(35, 35, 35, 40 * g_ui.m_fade));

  // title.
  g_ui.m_draw.text(g_render.m_fonts.menu.main,
                   {this->m_area.m_x + (this->m_area.m_w + 5), this->m_area.m_y}, this->m_name,
                   g_ui.m_theme, e_text_alignment::text_align_left);
