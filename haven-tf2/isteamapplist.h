...
//	This interface lets you detect installed apps for the local Steam client, useful for
// debugging tools 	to offer lists of apps to debug via Steam.
//-----------------------------------------------------------------------------
class ISteamAppList {
public:
  ...
  virtual int
  GetAppBuildId(AppId_t nAppID) = 0; // return the buildid of this app, may change at any time
                                     // based on backend updates to the game
};
...
STEAM_DEFINE_USER_INTERFACE_ACCESSOR(ISteamAppList*, SteamAppList,
