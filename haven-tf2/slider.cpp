...
void c_slider::paint( ) {
	// set our bar area.
	this->bar_area_ = { this->m_area.m_x + ( this->m_area.m_w - ( this->m_area.m_w * 0.5f ) ), this->m_area.m_y + 2, this->m_area.m_w * 0.5f, 10 };
	...
	// fill.
	g_ui.m_draw.filled_rect( { this->bar_area_.m_x, this->bar_area_.m_y, this->filling_, this->bar_area_.m_h }, g_ui.m_theme );
	...
	// title.
	g_ui.m_theme.m_a = 100 * g_ui.m_fade;
	g_ui.m_draw.text( g_render.m_fonts.menu.main, { this->m_area.m_x, this->m_area.m_y }, this->m_name, g_ui.m_theme, e_text_alignment::text_align_left );
	...
	g_ui.m_draw.text( g_render.m_fonts.menu.main, { std::clamp( this->bar_area_.m_x + this->filling_, this->bar_area_.m_x, this->bar_area_.m_x + this->bar_area_.m_w - text_size.m_x ), this->bar_area_.m_y + 1 }, buffer, color( 255, 255, 255, 100 * g_ui.m_fade ) , e_text_alignment::text_align_left );
}
...
void c_slider::update( ) {
	...
	this->m_value = static_cast< int >( std::clamp( this->m_min + (( this->m_max - this->m_min ) * (( g_input.m_mouse_pos.m_x - this->bar_area_.m_x ) / this->bar_area_.m_w )), this->m_min, this->m_max ) );
}