...
public:
	...
	virtual void add_swept_box_overlay( const vector& start, const vector& end, const vector& mins, const vector& max, const vector& angles, int r, int g, int b, int a, float fl_duration ) = 0;
	...
	virtual void add_box_overlay2( const vector& origin, const vector& mins, const vector& max, vector const& orientation, const color& face_color, const color& edge_color, float duration ) = 0;
};