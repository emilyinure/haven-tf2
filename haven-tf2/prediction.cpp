...
void prediction::start() {
  ...
  static auto update_buttons =
      g_modules.get("client.dll")
          .get_sig("44 8B 81 24 16 00 00 89 91 24 16 00 00 44 89 81 18 16 00 00 44 33 C2 41 8B "
                   "C0 23 C2 F7 D2 41 23 D0 89 81 1C 16 00 00 89 91 20 16 00 00 C3")
          .as<int (*)(c_base_entity*, int)>();
  ...
  g_interfaces.m_prediction->SetupMove(g_cl.m_local, g_cl.m_cmd, g_interfaces.m_move_helper,
                                       &m_MoveData);
